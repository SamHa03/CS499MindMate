...
const BreathingAction = () => {
  // modal stuff
  const [modalVisibility1, setModalIsVisible1] = useState(false); // modal is not visible
  const [modalVisibility2, setModalIsVisible2] = useState(false); // modal is not visible
  const [modalVisibility10, setModalIsVisible10] = useState(false); // modal is not visible
  const [modalVisibility30, setModalIsVisible30] = useState(false); // modal is not visible
  const [modalVisibility5, setModalIsVisible5] = useState(false); // modal is not visible
  const [modalVisibilityHour, setModalIsVisibleHour] = useState(false); // modal is not visible
  ...
  // TODO: start the countdown to the timer, make sure the timer doesn't underflow
  const startPomTimer = () => {
